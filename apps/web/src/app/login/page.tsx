          ...
          <div className="rounded bg-neutral-900 border border-neutral-800 p-5 shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b border-neutral-800 pb-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-xs font-mono font-semibold text-neutral-200">INC-2026-8941</span>
                <span className="text-xs text-neutral-500">•</span>
                <span className="text-xs font-medium text-neutral-300">Payment Gateway Latency Surge</span>
              </div>
              <span className="px-2.5 py-0.5 rounded text-[10px] font-mono font-semibold bg-rose-500/10 text-rose-400 border border-rose-500/20 whitespace-nowrap">
                SEV-1 CRITICAL
              </span>
            </div>

            <div className="grid grid-cols-2 gap-3 text-xs">
              <div className="p-3 rounded bg-[#171717] border border-neutral-800">
                <span className="text-[10px] font-mono text-neutral-500 uppercase tracking-wider block">Signal Correlation</span>
                <span className="text-xs font-semibold text-neutral-200 mt-1 block">14 Telemetry Alerts Grouped</span>
                <span className="text-[11px] text-rose-400 mt-0.5 block font-mono">Error Rate: 14.8% (+11.2%)</span>
              </div>
              <div className="p-3 rounded bg-[#171717] border border-neutral-800">
                <span className="text-[10px] font-mono text-neutral-500 uppercase tracking-wider block">AI Root Cause Analysis</span>
                <span className="text-xs font-semibold text-neutral-200 mt-1 block truncate">DB Connection Pool Starvation</span>
                <span className="text-[11px] text-emerald-400 mt-0.5 block font-mono">Confidence: 94%</span>
              </div>
            </div>

            <div className="pt-1 flex items-center justify-between text-[11px] text-neutral-400 border-t border-neutral-800">
              <span className="flex items-center text-emerald-400 gap-1.5 font-medium">
                <CheckCircle2 className="w-3.5 h-3.5" />
                Evidence Log & Commit Traces Attached
              </span>
              <span className="text-neutral-500 font-mono text-[10px]">Human-in-the-Loop Safeguard</span>
            </div>
          </div>

          <div className="grid grid-cols-3 gap-4 pt-2 border-t border-neutral-800">
            <div className="space-y-1">
              <span className="text-xs font-medium text-neutral-200 block">Sub-10s Alert Correlation</span>
              <p className="text-[11px] text-neutral-500">Clusters telemetry alerts into unified incident graphs.</p>
            </div>
            <div className="space-y-1">
              <span className="text-xs font-medium text-neutral-200 block">Root Cause Hypotheses</span>
              <p className="text-[11px] text-neutral-500">Maps commits, deployments, and log stack traces.</p>
            </div>
            <div className="space-y-1">
              <span className="text-xs font-medium text-neutral-200 block">Audit & Postmortems</span>
        ...
        <div className="w-full max-w-sm space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <a href="#" className="text-xs text-neutral-400 hover:text-neutral-200 transition-colors">Forgot password?</a>
              </div>
              <div className="relative">
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center space-x-2 text-neutral-400 cursor-pointer">
                <input type="checkbox" className="rounded bg-neutral-900 border-neutral-800 text-terracotta-500 focus:ring-0 accent-terracotta-500" />
          ...
          <div className="pt-6 border-t border-neutral-800 space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-[11px] font-mono font-semibold uppercase tracking-wider text-neutral-400">1-Click Demo Access</span>
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="p-2.5 rounded bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 text-left transition-colors group"
              >
                <span className="text-[11px] font-medium text-neutral-200 block group-hover:text-white transition-colors">
                  Engineer
                </span>
              ...
              <button
                ...
                className="p-2.5 rounded bg-neutral-900 hover:bg-neutral-800 border border-neutral-800 text-left transition-colors group"
              >
                <span className="text-[11px] font-medium text-neutral-200 block group-hover:text-white transition-colors truncate">
                  Manager
                </span>
